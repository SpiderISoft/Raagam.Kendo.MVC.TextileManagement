...
{
    public class DepartmentPurchaseRequisitionController : Controller
    {
        ProductionClient productionServiceClient;

        public DepartmentPurchaseRequisitionController()
        {
            productionServiceClient = new ProductionClient();
        }

        public ActionResult DepartmentPurchaseRequisition()
        {
            string url = "~/Views/Production/DepartmentPurchaseRequisition.cshtml";
            ...
            departmentPurchaseRequisitionHeaderModel = productionServiceClient.DeptPurReqPopulateDropDown();
        ...
        {
            DepartmentPurchaseRequisitionHeaderModel departmentPurchaseRequisitionHeaderModel = new DepartmentPurchaseRequisitionHeaderModel();
            departmentPurchaseRequisitionHeaderModel = (DepartmentPurchaseRequisitionHeaderModel)TempData["departmentPurchaseRequisitionHeaderModel"];
        ...
        {
            List<DepartmentPurchaseRequisitionTrailerModel> departmentPurchaseRequisitionTrailerModelList = new List<DepartmentPurchaseRequisitionTrailerModel>();
            DepartmentPurchaseRequisitionHeaderModel departmentPurchaseRequisitionHeaderModel = new DepartmentPurchaseRequisitionHeaderModel();
            departmentPurchaseRequisitionHeaderModel = (DepartmentPurchaseRequisitionHeaderModel)  TempData["departmentPurchaseRequisitionHeaderModel"];
        ...
        [HttpPost]
        public ActionResult SaveDepartmentPurchaseRequisition(DepartmentPurchaseRequisitionHeaderModel departmentPurchaseRequisitionHeaderModel, List<DepartmentPurchaseRequisitionTrailerModel> departmentPurchaseRequisitionTrailerModel)
        {
            ...
            departmentPurchaseRequisitionHeaderModel = productionServiceClient.SaveDepartmentPurchaseRequisition(departmentPurchaseRequisitionHeaderModel);
        ...
        {
            DepartmentPurchaseRequisitionHeaderModel TempDepartmentPurchaseRequisitionHeaderModel = new DepartmentPurchaseRequisitionHeaderModel();

            TempDepartmentPurchaseRequisitionHeaderModel = (DepartmentPurchaseRequisitionHeaderModel)TempData["departmentPurchaseRequisitionHeaderModel"];

            DepartmentPurchaseRequisitionHeaderModel departmentPurchaseRequisitionHeaderModel = productionServiceClient.SelectDepartmentPurchaseRequisition(DepartmentPurchaseRequisitionNumber);
