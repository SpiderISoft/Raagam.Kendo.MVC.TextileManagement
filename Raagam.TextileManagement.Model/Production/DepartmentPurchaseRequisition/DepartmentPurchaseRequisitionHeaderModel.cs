...
{
    [DataContract]
    public class DepartmentPurchaseRequisitionHeaderModel
    {

        public DepartmentPurchaseRequisitionHeaderModel()
        {
            ...
            DepartmentPurchaseRequisitionTrailerModelList = new List<DepartmentPurchaseRequisitionTrailerModel>();
        ...
        [DataMember]
        public List<DepartmentPurchaseRequisitionTrailerModel> DepartmentPurchaseRequisitionTrailerModelList { get; set; }
